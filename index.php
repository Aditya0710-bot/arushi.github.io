     ...
     <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6 col-md-6 col-12">
          <img src="images/cc6.jpg" class="img-fluid aboutimg">
        </div>
        <div class="col-lg-6 col-md-6 col-12">
          <h2 class="display-4">I am Aadi Chauhan.</h2>
          <p class="py-3">Welocome to my website,which is great and intresting to you.</p>
